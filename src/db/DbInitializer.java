            ...
            if (tables.next()) {
                ...
                try (Statement stmt = conn.createStatement()) {
                    ...
                    try {
                        ...
                        cols.close();
                    } catch (Exception e) { System.err.println("Users migration error: " + e.getMessage()); }
                    ...
                    try {
                        ...
                        cols.close();
                    } catch (Exception e) { System.err.println("Bills payment_mode migration error: " + e.getMessage()); }
                    ...
                    try {
                        ...
                        cols.close();
                    } catch (Exception e) { System.err.println("Bills cash_received migration error: " + e.getMessage()); }
                    ...
                    try {
                        ...
                        cols.close();
                    } catch (Exception e) { System.err.println("Bills cash_returned migration error: " + e.getMessage()); }
                    ...
                    try {
                        ...
                        cols.close();
                    } catch (Exception e) { System.err.println("Bills status migration error: " + e.getMessage()); }
                    ...
                    } catch (Exception e) { System.err.println("Index migration error: " + e.getMessage()); }
                    ...
                    try {
                        ...
                        cols.close();
                    } catch (Exception e) { System.err.println("Products alert_threshold migration error: " + e.getMessage()); }
                    ...
                    try {
                        ...
                        cols.close();
                    } catch (Exception e) { System.err.println("Products held_quantity migration error: " + e.getMessage()); }
                    ...
                    try {
                        ...
                        tbls.close();
                    } catch (Exception e) { System.err.println("cashier_drafts table creation error: " + e.getMessage()); }
